...
<script src="bower_components/jqueryShapeshift/core/jquery.shapeshift.js"></script>
...
<script src="bower_components/angular-modal-service/dst/angular-modal-service.js"></script>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/draggabilly/2.1.1/draggabilly.pkgd.min.js" charset="utf-8"></script>
    <script src="bower_components/angular/angular.min.js" charset="utf-8"></script>
    <script src="bower_components/jqueryShapeshift/core/vendor/jquery.touch-punch.min.js"></script>
    <script src="bower_components/angular-animate/angular-animate.min.js"></script>
    <script src="bower_components/jqueryShapeshift/core/jquery.shapeshift.js"></script>
